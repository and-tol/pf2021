      ...
      <article className={styles.heroContent}>
        ...
        <div className={cn(styles.heroText, 'font-primary-color')}>
          ...
          <P>
            ...
            realized that a web designer should also know the technology. And I
          ...
          <P>
            ...
            frameworks are needed. I can take the necessary information from the
            designer's layout. I have experience working in a small team and
            independently.
          </P>
          <P>
        ...
        <a href={`/assets/data/${NAME_CV_FILE}`}>
